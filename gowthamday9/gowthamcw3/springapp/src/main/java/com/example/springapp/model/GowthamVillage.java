...
public class GowthamVillage {
    ...
    public GowthamVillage(){}
    public GowthamVillage(int villageId, String villageName, int numOfMen, int numOfWomen, int villagePopulation,
            int numOfSchools) {
