package com.example.gowthamknday6cw1.model;

import jakarta.persistence.Entity;
import jakarta.persistence.Id;

@Entity
public class GowthamChildren {
    @Id
    private int babyId;
    ...
    public GowthamChildren() {
    }
    public GowthamChildren(int babyId, String babyFirstName, String babyLastName, String fatherName, String motherName,
            String address) {
        this.babyId = babyId;
